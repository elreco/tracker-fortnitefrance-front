    ...
    >
      ...
      >
        <ul>
          ...
          >
            <img
              src="~assets/images/esports/hero-slider/hero-bg-1.jpg"
              data-bgcolor="#1d1429"
              alt=""
            ...
            >
              <img
                src="~assets/images/esports/hero-slider/hero-character-1.png"
                alt=""
                data-ww="['457px','385px','323px','261px']"
                data-hh="['591px','500px','420px','340px']"
                width="457"
                height="591"
                data-no-retina
              />
            ...
            <div
              ...
              data-hoffset="['775','520','430','320']"
              data-y="['top','top','top','top']"
              data-voffset="['195','150','120','105']"
            ...
            <div
              ...
              data-x="['left','left','left','left']"
              data-hoffset="['780','525','435','320']"
              data-y="['top','top','top','top']"
              data-voffset="['166','130','95','80']"
              data-width="none"
              data-height="none"
              data-whitespace="nowrap"
              data-type="text"
            ...
            <div
              id="slide1-layer5"
              class="tp-caption tp-resizeme alc-hero-slider__text rs-parallaxlevel-11"
              data-x="['left','left','left','left']"
              data-hoffset="['780','525','435','320']"
              data-y="['top','top','top','top']"
              data-voffset="['385','290','250','210']"
            ...
            <div
              ...
              data-x="['left','left','left','left']"
              data-hoffset="['775','525','435','320']"
              data-y="['bottom','bottom','bottom','bottom']"
              data-voffset="['125','160','105','90']"
              data-width="none"
              data-height="none"
              data-whitespace="nowrap"
              data-type="button"
            ...
            >
              <a
                href="_esports_team-player.html"
                class="btn btn-primary btn-icon-right"
                >Check the player's bio <i class="fas fa-angle-right"></i
              ></a>
            </div>
          </li>
          ...
          >
            <img
              src="~assets/images/esports/hero-slider/hero-bg-2.jpg"
              data-bgcolor="#1d1429"
              alt=""
              data-bgposition="center center"
              data-bgfit="cover"
            ...
            <div
              ...
              style="z-index: 9"
            >
              We welcome the new Fortdaite team roster to the
              <br />
              Alchemists family!
            </div>
            ...
            >
              <a
                ...
                >Get to know the team <i class="fas fa-angle-right"></i
              ></a>
            </div>
          </li>
          <li
          ...
          >
            <img
              src="~assets/images/esports/hero-slider/hero-bg-3.jpg"
              data-bgcolor="#1d1429"
              alt=""
              data-bgposition="center center"
              data-bgfit="cover"
            ...
            <div
              id="slide3-layer1"
              class="tp-caption alc-hero-slider__label tp-resizeme rs-parallaxlevel-11"
              data-x="['left','left','left','left']"
              data-hoffset="['128','80','40','20']"
              data-y="['top','top','top','top']"
              data-voffset="['120','130','100','78']"
              data-width="none"
              data-height="none"
              data-whitespace="nowrap"
              data-type="button"
              ...
              style="z-index: 10"
            >
              <span class="label posts__cat-label posts__cat-label--category-1"
                >The Team</span
              >
            </div>
            ...
            <div
              ...
              style="z-index: 10"
            >
              <span class="label posts__cat-label posts__cat-label--category-2"
                >L.O. Heroes</span
              >
            </div>
            ...
            <div
              id="slide3-layer3"
              class="tp-caption tp-resizeme alc-hero-slider__h alc-hero-slider__h--h2 rs-parallaxlevel-10"
              data-x="['left','left','left','left']"
              data-hoffset="['128','80','40','20']"
              data-y="['top','top','top','top']"
              data-voffset="['160','160','130','105']"
            ...
            <div
              id="slide1-layer6"
              class="tp-caption tp-resizeme alc-hero-slider__author-avatar rs-parallaxlevel-11"
              data-x="['left','left','left','left']"
              data-hoffset="['125','80','40','20']"
              data-y="['top','top','top','top']"
              data-voffset="['341','300','230','180']"
              data-width="none"
              data-height="none"
              data-whitespace="nowrap"
              data-type="image"
            ...
            >
              <img
                ...
                data-ww="['24px','24px','18px','15px']"
                data-hh="['24px','24px','18px','15px']"
                width="24"
                height="24"
                data-no-retina
              />
            ...
            <div
              id="slide3-layer7"
              class="tp-caption tp-resizeme alc-hero-slider__h alc-hero-slider__h--h6 rs-parallaxlevel-11"
              data-x="['left','left','left','left']"
              data-hoffset="['157','110','65','43']"
              data-y="['top','top','top','top']"
              data-voffset="['345','303','232','181']"
              data-width="none"
              data-height="none"
              data-whitespace="nowrap"
              data-type="text"
            ...
            >
              <a
                href="_esports_blog-post-3.html"
                class="btn btn-primary-inverse btn-icon-right"
