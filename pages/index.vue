					...
					<div class="header__primary-inner">
						...
						<nav class="main-nav">
							<ul class="main-nav__list">
								<li class=""><a href="_esports_index.html">Home</a>
									<ul class="main-nav__sub">
										<li class=""><a href="_esports_index.html">Home - version 1</a></li>
										<li class=""><a href="_esports_index-2.html">Home - version 2</a></li>
									</ul>
								</li>
									...
									<div class="main-nav__megamenu">
										<div class="row">
											...
											<ul class="col-lg-5 col-md-3 col-12 main-nav__ul main-nav__ul-3cols">
												...
												<li><a href="_esports_index.html">Home V1</a></li>
								...
								<li class=""><a href="_esports_team-overview.html">The Team</a>
									<!-- Mega Menu -->
										...
										<div class="row">
											<ul class="col-lg-4 col-md-4 col-12 main-nav__ul main-nav__ul-2cols">
												<li class="main-nav__title main-nav-banner  main-nav-banner--img-1">
													<a href="#" class="main-nav-banner__link">
														<span class="main-nav-banner__subtitle">Alchemists.X</span>
														<span class="main-nav-banner__title">Xenowatch</span>
													</a>
												</li>
											...
											<ul class="col-lg-4 col-md-4 col-12 main-nav__ul main-nav__ul-2cols">
												<li class="main-nav__title main-nav-banner  main-nav-banner--img-2">
													<a href="#" class="main-nav-banner__link">
														<span class="main-nav-banner__subtitle">Alchemists.GO</span>
														<span class="main-nav-banner__title">Striker GO</span>
													</a>
												</li>
											...
											<ul class="col-lg-4 col-md-4 col-12 main-nav__ul main-nav__ul-2cols">
												<li class="main-nav__title main-nav-banner  main-nav-banner--img-3">
													<a href="#" class="main-nav-banner__link">
														<span class="main-nav-banner__subtitle">Alchemists LOH</span>
														<span class="main-nav-banner__title">League of Heroes</span>
													</a>
												</li>
								...
								<li class="">
									<a href="_esports_shop-fullwidth.html">Shop</a>
									<ul class="main-nav__sub">
					...
					<ul>
						...
						<li data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0" data-saveperformance="off" data-title="Slide">
							...
							<div class="tp-caption tp-resizeme alc-hero-slider__h alc-hero-slider__h--h1 rs-parallaxlevel-10"
								...
								style="z-index: 6;">
									<div class="rs-looped rs-wave" data-speed="2" data-angle="0" data-radius="2px" data-origin="50% 50%">Sarah</div>
							</div>
							...
							<div class="tp-caption tp-resizeme alc-hero-slider__h alc-hero-slider__h--h1 alc-hero-slider__h--color-primary rs-parallaxlevel-10"
								...
								style="z-index: 7;">
									<div class="rs-looped rs-wave" data-speed="2" data-angle="0" data-radius="2px" data-origin="50% 50%">Valentine</div>
							</div>
							...
							<div class="tp-caption tp-resizeme alc-hero-slider__h alc-hero-slider__h--h5 rs-parallaxlevel-11"
								...
								data-type="text"
								data-typewriter='{"lines":"RANKED PLAYER","enabled":"on","speed":"80","delays":"1%7C100","looped":"on","cursorType":"one","blinking":"on","word_delay":"off","sequenced":"on","hide_cursor":"off","start_delay":"500","newline_delay":"1000","deletion_speed":"30","deletion_delay":"3000","blinking_speed":"500","linebreak_delay":"60","cursor_type":"one","background":"off"}'
								data-responsive_offset="on"
							...
							<div class="tp-caption tp-resizeme rs-parallaxlevel-10"
								...
								style="z-index: 10;"><a href="_esports_team-player.html" class="btn btn-primary btn-icon-right">Check the player's bio <i class="fas fa-angle-right"></i></a>
							</div>
						...
						<li data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0" data-saveperformance="off" data-title="Slide">
							...
							<div class="tp-caption tp-resizeme alc-hero-slider__h alc-hero-slider__h--h1 rs-parallaxlevel-10"
								...
								style="z-index: 6;">
									<div class="rs-looped rs-wave" data-speed="2" data-angle="0" data-radius="2px" data-origin="50% 50%">Alchemists</div>
							</div>
							...
							<div class="tp-caption tp-resizeme alc-hero-slider__text rs-parallaxlevel-11"
								...
								style="z-index: 9;">
								We welcome the new Fortdaite team roster to the <br> Alchemists family!
							</div>
							...
							<div class="post-grid__item col-sm-6">
								<div class="posts__item posts__item--card posts__item--category-1 posts__item--category-3  card">
									...
									<div class="posts__inner card__content">
										...
										<h6 class="posts__title posts__title--color-hover"><a href="_esports_blog-post-1.html">The Team defeated the L.A. Pirates 2-1 in the Pro League Quarterfinals</a></h6>
										<div class="posts__excerpt">
										...
										<div class="posts__item posts__item--tile posts__item--category-3  card">
											<figure class="posts__thumb">
												...
												<div class="posts__inner">
													...
													<h6 class="posts__title posts__title--lg posts__title--color-hover"><a href="_esports_blog-post-1.html">The New AR Rifle 245 will be awarded as a prize</a></h6>
										...
										<div class="posts__item posts__item--tile posts__item--category-2  card">
											<figure class="posts__thumb">
												...
												<div class="posts__inner">
													...
													<h6 class="posts__title  posts__title--color-hover"><a href="_esports_blog-post-1.html">A tech class is added to the human&#x27;s race</a></h6>
								...
								<div class="posts posts--simple-list posts--simple-list--xlg">
									<div class="posts__item posts__item--category-1">
										<div class="posts__inner">
											...
											<h6 class="posts__title"><a href="_esports_blog-post-2.html">League of Heroes "Jaxxy" character is gonna get a really big update</a></h6>
											<time datetime="2017-08-23" class="posts__date">August 27th, 2018</time>
											<div class="posts__excerpt">
												Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua ut enim ad minim.
											</div>
											<div class="posts__more">
												<a href="_esports_blog-post-2.html" class="btn btn-primary-inverse btn-icon-right">Read Full Story <i class="fas fa-angle-right"></i></a>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="post-grid__item col-sm-6">
								<div class="posts__item posts__item--card posts__item--category-4  card">
									...
									<div class="posts__inner card__content">
										<a href="_esports_blog-post-1.html" class="posts__cta"></a>
										<time datetime="2018-08-23" class="posts__date">August 27th, 2018</time>
										<h6 class="posts__title posts__title--color-hover"><a href="_esports_blog-post-1.html">New modes are coming in the next April update</a></h6>
									</div>
									<footer class="posts__footer card__footer">
										<div class="post-author">
											<figure class="post-author__avatar">
							...
							<div class="post-grid__item col-sm-6">
								<div class="posts__item posts__item--card posts__item--category-1 posts__item--category-4  card">
									...
									<div class="posts__inner card__content">
										<a href="_esports_blog-post-1.html" class="posts__cta"></a>
										<time datetime="2018-08-23" class="posts__date">August 23rd, 2018</time>
										<h6 class="posts__title posts__title--color-hover"><a href="_esports_blog-post-1.html">Kelly_Spiegel9 joins the Xenowatch team</a></h6>
									</div>
									<footer class="posts__footer card__footer">
										<div class="post-author">
											<figure class="post-author__avatar">
							...
							<div class="post-grid__item col-sm-6">
								<div class="posts__item posts__item--card posts__item--category-1  card">
									...
									<div class="posts__inner card__content">
										<a href="_esports_blog-post-1.html" class="posts__cta"></a>
										<time datetime="2018-08-23" class="posts__date">July 28th, 2018</time>
										<h6 class="posts__title posts__title--color-hover"><a href="_esports_blog-post-1.html">The team is going to New York for the Finals</a></h6>
									</div>
									<footer class="posts__footer card__footer">
										<div class="post-author">
											<figure class="post-author__avatar">
								...
								<div class="twitch-stream-wrapper">
									<a href="#" class="twitch-stream   card">
										...
										<div class="twitch-stream__body">
											...
											<div class="twitch-stream__status twitch-stream__status--scheduled">Starts in: <div class="twitch-stream__countdown-counter countdown-counter" data-date="June 18, 2021 21:00:00"></div></div>
									...
									<div class="widget-game-result__section-inner">
										...
										<div class="widget-game-result__main">
											...
											<div class="widget-game-result__score-wrap">
												...
												<a href="https://www.youtube.com/watch?v=XE0fU9PCrWE" class="widget-game-result__score-video-icon mp_iframe" data-toggle="tooltip" data-placement="bottom" title="Watch Replay"><i class="fas fa-play"></i></a>
											</div>
										...
										<div class="game-result__mvp">
											<div class="game-result__mvp-player">
												<div class="game-result__mvp-player-icon-holder">
													<span class="game-result__mvp-player-icon"><i class="far fa-star"></i></span>
												</div>
