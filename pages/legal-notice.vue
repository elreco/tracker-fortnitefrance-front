  ...
  <div class="site-content">
    <div class="container">
      ...
      <p>
        ...
        site
        <a href="//tracker.fortnitefrance.eu/">tracker.fortnitefrance.eu</a>
        l'identité des différents intervenants dans le cadre de sa réalisation
        et de son suivi :
      </p>
      <p>
        <strong>Propriétaire</strong> : Alexandre Le Corre – Freelance – rue du
        grand pré 49000 Angers<br />
        <strong>Créateur</strong> :
        <a target="blank" href="https://elreco.fr">Alexandre Le Corre</a><br />
        <strong>Responsable publication</strong> : Alexandre Le Corre –
        a.elreco@gmail.com<br />
        Le responsable publication est une personne physique ou une personne
        morale.<br />
        <strong>Webmaster</strong> : Alexandre Le Corre – a.elreco@gmail.com<br />
        <strong>Hébergeur</strong> : Digital Ocean – 101 6th Ave, New York, NY
        10013, États-Unis<br />
        Crédits : <br />
      ...
      <p>
        ...
        décidée par Alexandre Le Corre, qui s’efforcera alors de communiquer
        préalablement aux utilisateurs les dates et heures de l’intervention.
      </p>
      <p>
        Le site
        <a href="//tracker.fortnitefrance.eu/">tracker.fortnitefrance.eu</a> est
        mis à jour régulièrement par Alexandre Le Corre. De la même façon, les
      ...
      <p>
        Le site
        <a href="//tracker.fortnitefrance.eu/">tracker.fortnitefrance.eu</a> a
        pour objet de fournir une information concernant l’ensemble des
        activités de la société.
      </p>
      <p>
        Alexandre Le Corre s’efforce de fournir sur le site
        <a href="//tracker.fortnitefrance.eu/">tracker.fortnitefrance.eu</a> des
      ...
      <p>
        ...
        <a href="//tracker.fortnitefrance.eu/">tracker.fortnitefrance.eu</a> ne
      ...
      <p>
        Alexandre Le Corre est propriétaire des droits de propriété
      ...
      <p>
        ...
        préalable de : Alexandre Le Corre.
      </p>
      <p>
      ...
      <p>
        Alexandre Le Corre ne pourra être tenue responsable des dommages directs
        et indirects causés au matériel de l’utilisateur, lors de l’accès au
        site tracker.fortnitefrance.eu, et résultant soit de l’utilisation d’un
        matériel ne répondant pas aux spécifications indiquées au point 4, soit
        de l’apparition d’un bug ou d’une incompatibilité.
      </p>
      <p>
        Alexandre Le Corre ne pourra également être tenue responsable des
      ...
      <p>
        ...
        l’espace contact) sont à la disposition des utilisateurs. Alexandre Le
        Corre se réserve le droit de supprimer, sans mise en demeure préalable,
        ...
        protection des données. Le cas échéant, Alexandre Le Corre se réserve
      ...
      <p>
        ...
        <a href="//tracker.fortnitefrance.eu/">tracker.fortnitefrance.eu</a>, le
        fournisseur d'accès de l'utilisateur, l'adresse de protocole Internet
        (IP) de l'utilisateur.
      </p>
      <p>
        En tout état de cause Alexandre Le Corre ne collecte des informations
      ...
      <p>
        ...
        rachat de Alexandre Le Corre et de ses droits permettrait la
      ...
      <p>
        ...
        en place avec l’autorisation de Alexandre Le Corre. Cependant, Alexandre
        Le Corre n’a pas la possibilité de vérifier le contenu des sites ainsi
